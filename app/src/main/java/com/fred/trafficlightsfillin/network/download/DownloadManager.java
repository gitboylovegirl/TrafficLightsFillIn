...
import com.fred.trafficlightsfillin.network.http.core.BaseApiService;
...
public class DownloadManager {
    ...
    public void addDownloadInfo(DownloadInfo info) {
        ...
        if (!downloadInfos.contains(info)) {
            ...
            Retrofit.Builder retrofitBuilder = new Retrofit.Builder()
                    ...
                    .baseUrl(NetEnv.getInstance().getBaseUrl())
                    .addConverterFactory(GsonConverterFactory.create())
                    .addCallAdapterFactory(RxJava2CallAdapterFactory.create());
            commonRequest = retrofitBuilder.build().create(BaseApiService.class);
    ...
    public void restartDownload(DownloadInfo downloadInfo) {
        ...
        if (downloadInfo.getState() == DownloadInfo.DOWNLOAD) {
            return;
        }
